# Decision Gatekeepers: Replication Materials

Replication materials for "Decision Gatekeepers: How Hedonic vs. Utilitarian Products Shape Differential Persuasion Effects in LLM-Mediated Recommendations"
...
**Key Finding:** Identical persuasive marketing content produces differential effects depending on product type, predominantly amplifying recommendation certainty for hedonic products while attenuating it for utilitarian products.
...
- **3 Models:** GPT-4.1 Mini, GPT-5 Mini, Kimi K2-0905
...
```bibtex
@article{pescher2026decisiongatekeepers,
  title={Decision Gatekeepers: How Hedonic vs. Utilitarian Products Shape Differential Persuasion Effects in LLM-Mediated Recommendations},
